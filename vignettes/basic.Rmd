...
The `relations`, `elementData`, and `setData` slots can directly accessed using the eponym getter methods.
...
The `membership` slot can be directly accessed using the getter of the same name.
