...
It is also useful to note that the conversion of `Go3AnnDbBimap` Gene Ontology maps to `r Githubpkg("unisets")` objects automatically fetches metadata for each GO identifier from the `GO.db` package, if installed.
